...
\begin{Def}
$A \subset \R$.\\
$x \in R $ --- верхняя граница $A$, если $$\forall a \in A: a <= x$$
$x \in R $ --- нижняя граница $A$, если $$\forall a \in A: a >= x$$
\end{Def}
\begin{Def}
...
$$\forall a \in A\: \forall B \in B\: a \leqslant b \Ra \exists c \in \R: \forall a \in A: a \leqslant c \land \forall b \in B c \leqslant b \Ra \exists \sup A = c$$
...
\begin{theorem}{}
\begin{enumerate}
\item $A$ ограничено сверху. Тогда $$b = \sup A \Lra (\forall a \in A a \leqslant b \land \forall \epsilon > 0 \exists a \in A: a > b - \epsilon)$$
\item $A$ ограничено снизу. Тогда $$c = \inf A \Lra (\forall a \in A a \geqslant c \land \forall \epsilon > 0 \exists a \in A: a < c + \epsilon)$$
\end{enumerate}
\end{theorem}
\begin{proof}
$$b = \sup A \Lra (b \text{~--- верхняя граница } A \land \forall \epsilon > 0 b - \epsilon\text{~--- не верхняя граница}) \Lra $$ 
$$ \Lra (\forall a \in A a \leqslant b \land \forall \epsilon > 0 \exists a \in A: a > b - \epsilon)$$
\end{proof}
