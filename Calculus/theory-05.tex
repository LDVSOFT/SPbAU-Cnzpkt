...
\item Для любой последовательности в множестве можно выбрать подпоследовательность к некоторой точке множества
\end{enumerate}
\end{theorem}
\begin{proof}
$2 \Ra 1$: К ограниченно, значит можно его впихнуть в куб, значит оно подмножество компактного и закрыто, значит компактно.
% \end{proof}